...
namespace Regata.Desktop.WinForms.Measurements
{
    public partial class LoginForm : Form
    {
        ...
        private const string _ConStringTargetMainDB = "MeasurementsMainConnectionString";
        private const string _ConStringTargetTestDB = "MSSQL_TEST_DB_ConnectionString";
