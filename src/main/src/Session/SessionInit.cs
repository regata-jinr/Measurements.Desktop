...
namespace Regata.Desktop.WinForms.Measurements
{
    ...
    public partial class Session : IDisposable
    {
        ...
        /// <summary>
        /// List of irradiated samples with specified date and type. <see cref="Irradiation"/>
        /// </summary>
        public List<Irradiation> IrradiationList { get; private set; }
        ...
        public string Type
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!Measurement.SessionTypeMapStr.Values.Contains(value))
                        throw new ArgumentException($"Type of measurement should contained in this list [{string.Join(",", Measurement.SessionTypeMapStr.Values)}]");
        ...
        public event Action<Measurement> MeasurementOfSampleDone;
        ...
        public Dictionary<string, List<Measurement>> MeasurementsRegisters { get; private set; }
        ...
        public Session()
        {
            ...
            MeasurementsRegisters = new Dictionary<string, List<Measurement>>();
